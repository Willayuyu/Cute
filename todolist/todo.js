...
function addTodolist(e) {
    ...
    obj_list.todo = time.getFullYear() + "年" + time.getMonth() + "月" + time.getDate() + "日" + ten(time.getHours()) + ":" + ten(time.getMinutes()) + ":" + ten(time.getSeconds()) + "&nbsp&nbsp" + document.getElementById("add_list").value;
...
function update(i, field, value) {
    todolist[i][field] = time.getFullYear() + "年" + time.getMonth() + "月" + time.getDate() + "日" + ten(time.getHours()) + ":" + ten(time.getMinutes()) + ":" + ten(time.getSeconds()) + "&nbsp&nbsp" + value;
    saveData(todolist);
    load();
}
function remove(i) {
